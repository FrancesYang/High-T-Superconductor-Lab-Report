...
We used a two-phase lock-in amplifier for the BSCCO experiment. This allows us to separate the resistance from any contributions from induction or capacitance.
The BSCCO sample was connected in series with a 1 k$\Ohm$ resistor. This circuit was connected to a sinusoidal? voltage source with a RMS of 1 V. 
Since the resistance of the BSCCO compared to the resistor is much smaller, even at room temperature, the current going through the circuit is approximately $\pm$1 mA. 
