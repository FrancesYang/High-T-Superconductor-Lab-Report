...
In our experiment, we look at two high temperature superconductors, $\textrm{Yt}\textrm{Ba}_{2}\textrm{Cu}_{3}\textrm{O}_{7-\delta}$ and $\textrm{Bi}_{2}\textrm{Sr}_{2}\textrm{Ca}_{n-1}\textrm{Cu}_{n}\textrm{O}_{2n+4}$, where $n=1,2,\textrm{ or },3$. %n=3 mainly for colorado superconductor 110 Tc
...
\bibitem{ybcotemp} R. J. Cava, B. Batlogg, R. B. van Dover, D. W. Murphy, S. Sunshine, T. Siegrist, J. P. Remeika, E. A. Rietman, S. Zahurak, and G. P. Espinosa, "Bulk superconductivity at 91 K in sngle-phase oxygen-deficient perovskite $\textrm{Ba}_2\textrm{YCU}_3\textrm{O}_{9-\delta}$, Phys. Rev. Letters 58, 1676 (1987).

\bibitem{temps} J. M. Tarascon, W. R. McKinnon, P. Barboux, D. M. Hwang, B. G. Bagley, L. H. Greene, G. W. Hull, Y. LePage, N. Stoffel, and M. Giroud, "Preparation, structure, and properties of the superconducting compound series $\textrm{Bi}_2\textrm{Sr}_2\textrm{Ca}_{n-1}\textrm{Cu}_{n}\textrm{O}_y$ with $n=1,2,\textrm{ and }3$", Phys. Rev. B 38, 8885 (1998).
