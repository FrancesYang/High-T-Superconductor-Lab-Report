...
For the YBCO, we connected it to a source with an alternating current of $\pm$1 mA. The alternating current  
The voltage across the YBCO sample, $V_{\textrm{YBCO}}$, and the voltage across the thermocouple junction, $V_{T}$ were measured with two nanovoltmeters. \textcolor{blue}{you should explain the point of reversing the current and how this helps more accurately determine the true }$\Delta V$
