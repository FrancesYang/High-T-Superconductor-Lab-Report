...
\section{Procedure}
The YBCO and BSCCO superconductors were obtained from Colorado Superconductor Inc. Each superconductor  is contained in a brass casing with two pairs of leads. One pair is attached to the current source and the other pair was used to measure voltage across the superconductor. The casing also contains a thermocouple, which has a resistance that varies with temperature. We measure the voltage across the thermocouple to find the temperature of superconductor. We used different methods to measure the critical temperature of the two superconductors.

For the YBCO, we connected to an alternating current source of 1 mA. 
